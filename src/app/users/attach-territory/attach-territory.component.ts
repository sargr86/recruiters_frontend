...
@Component({
  selector: 'app-attach-territory',
  templateUrl: './attach-territory.component.html',
  styleUrls: ['./attach-territory.component.scss']
})
export class AttachTerritoryComponent implements OnInit {
